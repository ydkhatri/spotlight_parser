...
#
# A debug version that just gets property information
#
    ...
    def ParseItem(self, properties, categories, indexes_1, indexes_2):
        ...
        while  self.pos < self.size:
            ...
            if prop == None:
                ...
                prop_name = prop[0]
                if prop_name == '_kMDItemDocumentLineageData':
                    pass
                prop_type = prop[1]
                value_type = prop[2]
                value = ''
    ...
    try:
        with open(input_file_path, 'rb') as f:
            ...
            with open(output_path_data, 'wb') as output_file:
                output_file.write("Prop_Name\tProp_Type\tValue_Type\r\n")
                ...
                for k, prop in store.properties.items():
                    output_file.write(prop[0] + "\t" + str(prop[1]) + "\t" + str(prop[2]) + "\r\n")
...
if __name__ == "__main__":
    ...
    description = "This script just gets properties info. "  
